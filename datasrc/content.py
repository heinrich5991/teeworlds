...
image_freeze = Image("freeze", "freeze.png")
...
container.images.Add(image_freeze)
...
set_freeze = SpriteSet("freeze", image_freeze, 1, 1)
...
container.spritesets.Add(set_freeze)
...
container.sprites.Add(Sprite("frozen", set_freeze, 0,0,1,1))
