...
image_musicicons = Image("musicicons", "music_icons.png")
...
container.images.Add(image_musicicons)
...
set_musicicons = SpriteSet("musicicons", image_musicicons, 4, 3)
...
container.spritesets.Add(set_musicicons)
...
container.sprites.Add(Sprite("music_pause_normal", set_musicicons, 0,0,1,1))
container.sprites.Add(Sprite("music_play_normal", set_musicicons, 1,0,1,1))
container.sprites.Add(Sprite("music_prev_normal", set_musicicons, 2,0,1,1))
container.sprites.Add(Sprite("music_next_normal", set_musicicons, 3,0,1,1))
container.sprites.Add(Sprite("music_pause_hover", set_musicicons, 0,1,1,1))
container.sprites.Add(Sprite("music_play_hover", set_musicicons, 1,1,1,1))
container.sprites.Add(Sprite("music_prev_hover", set_musicicons, 2,1,1,1))
container.sprites.Add(Sprite("music_next_hover", set_musicicons, 3,1,1,1))
container.sprites.Add(Sprite("music_pause_down", set_musicicons, 0,2,1,1))
container.sprites.Add(Sprite("music_play_down", set_musicicons, 1,2,1,1))
container.sprites.Add(Sprite("music_prev_down", set_musicicons, 2,2,1,1))
container.sprites.Add(Sprite("music_next_down", set_musicicons, 3,2,1,1))
