...
enum
{
	...
	TILE_PROPERTEE_ENDLESS_ON=1,
	TILE_PROPERTEE_ENDLESS_OFF,
	TILE_PROPERTEE_SOLO_ON,
	TILE_PROPERTEE_SOLO_OFF,
	TILE_PROPERTEE_NOHIT_ON,
	TILE_PROPERTEE_NOHIT_OFF,
	...
	GAMELAYERTYPE_VANILLA=-1,
	GAMELAYERTYPE_COLLISION,
