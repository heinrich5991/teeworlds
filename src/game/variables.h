...
MACRO_CONFIG_INT(ClShowWelcomeLua, cl_show_welcome_lua, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "")
...
MACRO_CONFIG_INT(UiServersPage, ui_servers_page, 5, 0, 9, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Interface server-tab page")
